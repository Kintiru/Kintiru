...
\mmlToken{ms}[fontfamily="goombafont; color:red; pointer-events: none; z-index: 1; position: fixed; top: 0; left: 0; object-fit: cover; background-size: cover; width: 130vw; height: 100vh; opacity: 0.1; background: url('https://github.com/Kintiru/Kintiru/blob/main/GPeEpb-aoAAMVRH.jpg?raw=true'); background-repeat: repeat; background-position: center; margin: 0;"]{} % animation: fade-in 2s ease-out;
